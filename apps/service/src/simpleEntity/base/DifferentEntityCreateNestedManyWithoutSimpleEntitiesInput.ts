...
@InputType()
class DifferentEntityCreateNestedManyWithoutSimpleEntitiesInput {
...
export { DifferentEntityCreateNestedManyWithoutSimpleEntitiesInput as DifferentEntityCreateNestedManyWithoutSimpleEntitiesInput };
